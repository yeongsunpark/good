...
class SquadDb():
    ...
    def __init__(self):
        ...
        self.qna_table = "(%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)"
        self.con = None
        self.cur = None
        self.context_ori = ""
    ...
    def insert_data(self, table, value_part, var_tuple, morph_end):
        if "context" in table:
            ...
            sql = "INSERT INTO {}(c_id, q_id, question{}, answer_start{}, answer_end{}, answer{}, numType, classType, isFlexible, reason, reason_start_index, reason_end_index) VALUES {}".\
    ...
    def squad2db(self, json_location, start_id, season, data_type, table_name, q_id_index):
        ...
        for d in data:
            ...
            for qa, i in zip (d['main_qa_list'], range(len(d['main_qa_list']))):
                ...
                reason = qa['reason']
                reason_start_i = qa['reason_start']
