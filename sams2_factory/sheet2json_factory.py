...
class check():
    # def __init__(self):
        # self.version = "number3"

    def main(self, sheet, range_name, s_id, version):
        result = {'version': version, 'data': list()}  # 여기에 빼줘야 계속 누적 되어 적힘.
        # f = quick('19_박원아(8/5~)!A1:k3')
        f = quick(sheet+'!'+range_name, s_id)
        ...
        for line in f:
            ...
            if answer == "" or answer == "#VALUE!":  # 답 없는 질문
        ...
        with open("/home/msl/ys/cute/data/sams2/{}.json".format(version), "w") as f2:
...
if __name__ == '__main__':
    ...
    parser.add_argument('-id', '--sheet_id', type=str, default=None)
    ...
    if args.sheet_id != None:
        s_id = args.sheet_id
        sheet = args.sheet_name
        range_name = args.range_name
        version = args.version
    else:
        s_id = "1eFFYCRRkjgD_FKUzL5kvFThsmnfbLTu7E_pOC8GROo4"
        sheet = "시트1"
        range_name = "A2:k6824"  # From A2
        version = "number0"
    c = check()
    c.main(sheet, range_name, s_id, version)